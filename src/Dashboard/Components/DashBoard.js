...
import LineChartComponent from './ChartsComponent';
import SummaryCard from './CardsComponent';
...
const Dashboard = () => {
    ...
    useEffect(() => {
        const savedComponents = localStorage.getItem('dashboard-layout');
        if (savedComponents) {
    ...
    const onDragEnd = (result) => {
        ...
        localStorage.setItem('dashboard-layout', JSON.stringify(reorderedItems));
    };
    ...
    const handleRemove = (id) => {
        ...
        localStorage.setItem('dashboard-layout', JSON.stringify(updatedComponents));
    };
